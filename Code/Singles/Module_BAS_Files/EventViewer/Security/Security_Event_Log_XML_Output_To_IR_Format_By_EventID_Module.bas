...
Sub Security_Event_Log_XML_Output_To_IR_Format_By_EventID()
...
MsgBox "Select the file that contains the Security EventIDs to Keep"

evtIdFilePath = Application.GetOpenFilename(Title:="Open Security EventIDs File")
...
'------------------------------------------------------------------------------
'Create an array with contents of Security EventIDs file
