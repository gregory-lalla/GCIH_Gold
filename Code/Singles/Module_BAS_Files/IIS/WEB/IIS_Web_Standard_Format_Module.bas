...
Sub IIS_Web_Log_Standard_Format()
...
'--------------------------------------------------------------------------
'This code section deletes extra headers
'--------------------------------------------------------------------------
...
Do Until IsEmpty(ActiveCell)
    ...
    Cells(f, "C") = "Server IP: " & Cells(f, "C") & " | Server Prt: " & Cells(f, "G")
    Cells(f, "D") = Cells(f, "D") & ": " & Cells(f, "E")
    Cells(f, "I") = "Client IP: " & Cells(f, "I")
...
'--------------------------------------------------------------------------
Sheets(1).Range("B:B,E:H,J:J,L:O").EntireColumn.Delete
